...
description: "Claude's Agent Teams shipped alongside Opus 4.6. How does it compare to Gas Town, claude-flow, and the community tools that got here first?"
date: 2026-02-05
type: post
schemaVersion: 1
draft: true
...
preface: "Claude Code just shipped native multi-agent support. The question isn't whether to use it—it's whether the external tools it's replacing were solving the right problem."
---
...
*What's your multi-agent setup? I'm curious whether people are actually using these tools or still running vanilla Claude Code. The gap between what's possible and what's practical feels wider here than anywhere else in AI tooling.*
