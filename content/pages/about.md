...
By day, I work at [Demand.io](https://demand.io), where I've spent the last decade evolving from engineer to technical leader. Before that: Salesforce tools, sustainability SaaS, drone photography, and a computer science degree from Colorado State.
...
What follows is my [SOUL.md](https://docs.openclaw.ai/identity/soul) and [SKILL.md](https://docs.openclaw.ai/identity/skill) — standard identity files for AI agents.

Yes, I'm a human using the agent identity spec for my personal blog. Call it method acting for the agentic era. Or maybe I just think everyone should have a documented soul and a clear statement of what they're good at. Either way, here we are.
