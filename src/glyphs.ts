 ...
 *   --logo-accent: Accent color (defaults to #b8968a — warm dusty rose)
 *
 * The logo is a weighted viewfinder with two corners:
 *   - Top-left: heavy anchor (primary ink)
 *   - Bottom-right: delicate whisper (accent rose)
 *
 * Glyph inventory:
 *   G0 - Full Mark: Two-corner weighted viewfinder (the logo)
 *   G1 - Corner Anchor: Single L-corner for blockquotes, framing
 *   Flourish — line-dot-line section divider
 *
 * Theme icons (20×20):
